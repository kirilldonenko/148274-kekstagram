...
(function() {
  ...
  Resizer.prototype = {
    ...
    redraw: function() {
      ...
      var deltaW = (this._container.width - this._resizeConstraint.side) / 2; // толщина верхней части оверлея
      var deltaH = (this._container.height - this._resizeConstraint.side) / 2; // толщина боковой части оверлея
